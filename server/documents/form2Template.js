      ...
      <div class="content">
        ...
        <div class="table-container">
          <table>
            ...
            <tr>
              <th>Faculty Name /EID</th>
              <td>${formData.facultyName}</td>
              <th>Mobile Number</th>
            ...
            <tr>
              <th>Prior Experience in Co-Curricular Domain(Years)</th>
              <td>${formData.coCurricularExperience}</td>
              <th>Department/ Institute</th>
              <td>${formData.department}</td>
            </tr>
            <tr>
              <th>Specialization</th>
              <td colspan="3">${formData.specialization}</td>
            </tr>
            <tr>
              <th>Previous Related Achievements [Certifications/ Recognitions/Patents/ Research papers [SCI,SCOPUS] /Leadership]</th>
              <td colspan="3">${formData.achievements}</td>
            </tr>
            <tr>
              <th>Proposed Vision for Club</th>
              <td colspan="3">${formData.vision}</td>
            </tr>
            <tr>
              <th>Proposed Flagship Event</th>
              <td colspan="3">${formData.flagshipEvent}</td>
            </tr>
            <tr>
              <th>Nomination</th>
              <td></td>
            ...
            <tr>
              ...
              <td>${formData.name}</td>
              <th>Designation</th>
              <td>${formData.nomineeDesignation}</td>
            </tr>
          </table>
        </div>
        <hr>
